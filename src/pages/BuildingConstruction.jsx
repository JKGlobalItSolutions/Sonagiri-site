  ...
  return (
    ...
    style={{padding:"0px 12px"}}>
      ...
      <div className="text-center mb-5">
        <h2 className="fw-bold " style={{color:"#335393"}}>
        ...
        {steps.map((step, index) => (
          <div className="col-md-6" key={index}>
            <div className="border rounded shadow-sm h-100">
              <div className="text-white p-2 fw-bold rounded-top" style={{backgroundColor:"#335393"}}>
                {step.title}
              </div>
              <div className="p-3">
                {step.items.map((item, idx) => (
                  <div className="d-flex align-items-start mb-2" key={idx}>
                    <i className="bi bi-check-circle-fill me-2 mt-1"  style={{color:"#335393"}}></i>
                    <span>{item}</span>
                  </div>
                ))}
              </div>
