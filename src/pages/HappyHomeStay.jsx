      ...
      <div className="container py-4">
        <div className="row text-center justify-content-center">
          <div className="col-4 col-md-2 mb-3">
            <FaHome size={28} className=" accordion-collapse mb-2"   style={{color:"#335393"}}/>
            <p className="mb-0 small">Happy Home Stay</p>
          </div>
          <div className="col-4 col-md-2 mb-3">
            <FaLock size={28} className=" mb-2"  style={{color:"#335393"}} />
            <p className="mb-0 small">24hrs Security</p>
          </div>
          <div className="col-4 col-md-2 mb-3">
            <FaTint size={28} className=" mb-2"   style={{color:"#335393"}}/>
            <p className="mb-0 small">24hrs Water Supply</p>
          </div>
          <div className="col-4 col-md-2 mb-3">
            <FaCheckCircle size={28} className=" mb-2"  style={{color:"#335393"}} />
            <p className="mb-0 small">Well Maintained</p>
          </div>
          <div className="col-4 col-md-2 mb-3">
            <FaGlobe size={28} className=" mb-2"   style={{color:"#335393"}}/>
...
<div className="container my-5">
  <div className="row align-items-center">
    <div className="col-md-7">
      <h6 className="text-uppercase " style={{color:"#335393"}} >Comfortable Stays</h6>
...
<div className="container my-5">
  <div className="row align-items-center flex-md-row-reverse">
    <div className="col-md-7">
   <h6 className="text-uppercase " style={{color:"#335393"}} >24x7 Surveillance</h6>
...
<div className="container my-5">
  <div className="row align-items-center">
    <div className="col-md-7">
   <h6 className="text-uppercase " style={{color:"#335393"}} >24x7 Water Supply</h6>
...
<div className="container my-5">
  <div className="row align-items-center flex-md-row-reverse">
    <div className="col-md-7">
   <h6 className="text-uppercase " style={{color:"#335393"}} >Clean & Fresh Ambience</h6>
...
<div className="container my-5">
  <div className="row align-items-center">
    <div className="col-md-7">
   <h6 className="text-uppercase " style={{color:"#335393"}} >Local Experiences</h6>
