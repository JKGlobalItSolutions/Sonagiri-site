            ...
            <thead className="table-light">
              <tr>
                ...
                <th>
                  ...
                  ₹750 /month + GST
                  <br />
                  <button className="btn  mt-2" style={{color:"white" , backgroundColor:"#335393"}}>Enquire</button>
                </th>
                <th>
                  Gold <br />
                  (1 year)
...
<section className="info-section container my-5 p-5 rounded bg-white border shadow-sm">
  <h3 className=" fw-bold mb-3" style={{color:"#335393"}}>INVENTORY CHECK</h3>
  ...
  <h3 className=" fw-bold mb-3" style={{color:"#335393"}}>RENTAL/LEASE AGREEMENT</h3>
  <p className="mb-4 text-secondary">
  ...
  <h3 className=" fw-bold mb-3" style={{color:"#335393"}}>EXPLAINING RESTRICTIONS AND RESPONSIBILITIES</h3>
  <p className="mb-4 text-secondary">
  ...
  <h3 className=" fw-bold mb-3" style={{color:"#335393"}}>REGULAR PROPERTY INSPECTION</h3>
  <p className="mb-4 text-secondary">
  ...
  <h3 className=" fw-bold mb-3" style={{color:"#335393"}}>EXIT INVENTORY CHECK</h3>
  <p className="mb-4 text-secondary">
