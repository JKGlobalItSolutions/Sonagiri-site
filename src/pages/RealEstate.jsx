...
>>>>>>> e40b9daaf09f80ed4020581fb9f347d0111442ec
      ...
      <div className="container my-5">
        <h2 className="fw-bold text-center mb-5 " style={{color:"#335393"}}>
          Buyer Support Program
        </h2>
        ...
        <div className="row g-4">
          ...
          {[
            ...
            <div className="col-md-6" key={idx}>
              <div className="card shadow-sm h-100 " style={{borderColor:"#335393"}}>
                <div className="card-header  text-white fw-bold"   style={{backgroundColor:"#335393"}}>
                  {stepData.step}
                </div>
                  ...
                  <ul className="list-unstyled mb-0">
                    {stepData.points.map((point, i) => (
                      <li key={i} className="mb-2 d-flex align-items-start">
                        <span className="me-2 " style={{color:"#335393"}}>
